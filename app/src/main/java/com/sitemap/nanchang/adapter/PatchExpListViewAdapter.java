...
public class PatchExpListViewAdapter extends BaseExpandableListAdapter {
    ...
    public interface OnCallBackUpdate {
        ...
        void onClickDeleteListener(int groupPosition, int type);
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        if (convertView == null){
            ...
            groupHolder.del = (TextView) convertView.findViewById(R.id.gather_del);
            groupHolder.isShow = (LinearLayout) convertView.findViewById(R.id.gather_is_show);
...
//            convertView.setClickable(true);
        ...
        if (mList.get(groupPosition).getPatchModelList().size()==0){
            if (mList.get(groupPosition).getIsStatus().equals("1")){//展开
                groupHolder.isShow.setVisibility(View.VISIBLE);
                groupHolder.del.setVisibility(View.VISIBLE);
            }else{
                groupHolder.isShow.setVisibility(View.GONE);
        ...
        groupHolder.del.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mCallBack!=null){
                    mCallBack.onClickDeleteListener(pos, 1);
                }
            }
        });
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        childHolder.del.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mCallBack!=null){
                    mCallBack.onClickDeleteListener(groupPos, 1);
                }
            }
        });
    ...
    private class GroupHolder{
        ...
        TextView add,name,del;//增加 删除
        ImageView status;//状态
        LinearLayout mLayout,isShow;//布局
    }
